...
class YGLayout {
  ...
  val measuredDimensions = ArrayList(listOf(GlobalMembers.YGUndefined, GlobalMembers.YGUndefined))
  ...
  fun direction(): YGDirection {
    return app.cash.redwood.yoga.detail.GlobalMembers.Companion.getEnumData<YGDirection>(
      YGDirection::class, flags, directionOffset,
    )
  }

  fun setDirection(direction: YGDirection) {
    app.cash.redwood.yoga.detail.GlobalMembers.Companion.setEnumData<YGDirection>(
      YGDirection::class, flags, directionOffset, direction,
    )
  }

  fun didUseLegacyFlag(): Boolean {
    return app.cash.redwood.yoga.detail.GlobalMembers.Companion.getBooleanData(
      flags,
  ...
  fun setDidUseLegacyFlag(`val`: Boolean) {
    app.cash.redwood.yoga.detail.GlobalMembers.Companion.setBooleanData(
      flags,
      didUseLegacyFlagOffset,
      `val`,
    )
  ...
  companion object {
    ...
    private val didUseLegacyFlagOffset: Int =
      directionOffset + app.cash.redwood.yoga.detail.GlobalMembers.Companion.bitWidthFn<YGDirection>()
