...
/**
 * A synthetic children wrapper which allows nodes to have multiple children slots without
 * actually forcing intermediate nodes on the display-side.
 *
 * Named weirdly to prevent normal usage since bad things will happen.
 */
@Composable
