...
public actual class ProtocolState actual constructor(
  ...
  public actual fun appendCreate(
    ...
    val id = id
    val tag = tag
    changes.add(js("""["create",{"id":id,"tag":tag}]"""))
  }
  ...
  public actual fun <T> appendPropertyChange(
    ...
    changes.add(js("""["property",{"id":id,"tag":tag,"value":encodedValue}]"""))
  }
  ...
  public actual fun appendPropertyChange(
    ...
    val tag = tag
    val value = value
    changes.add(js("""["property",{"id":id,"tag":tag,"value":value}]"""))
  }
  ...
  public actual fun appendModifierChange(
    ...
    changes.add(js("""["modifier",{"id":id,"elements":elements}]"""))
  }
  ...
  public actual fun appendAdd(
    ...
    val childId = childId
    val index = index
    changes.add(js("""["add",{"id":id,"tag":tag,"childId":childId,"index":index}]"""))
  }
  ...
  public actual fun appendMove(
    ...
    val toIndex = toIndex
    val count = count
    changes.add(js("""["move",{"id":id,"tag":tag,"fromIndex":fromIndex,"toIndex":toIndex,"count":count}]"""))
  }
  ...
  public actual fun appendRemove(
    ...
    changes.add(js("""["remove",{"id":id,"tag":tag,"index":index,"count":count,"removedIds":removedIds}]"""))
  }
